                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <!--untuk menampung inputan id user -->
                         ...
                         <td><input type="hidden" id="qty"
                                    placeholder="Stok" name="qty" value="0" class="form-control form-control-user"></td></tr>
                            </div>

                            <!--untuk menampung password dari user-->
                            <div class="form-group"><tr>
                               <td>Harga</td><td>:</td> <td><input type="number"  id="qty"
                                    placeholder="Harga" name="harga" class="form-control form-control-user"></td><td>,</td><td><input type="number"  id="qty"
                                    placeholder="Harga" name="harga_lagi" class="form-control form-control-user" value="00"></td></tr>
                            </div>
                            ...
                            <div class="input-field"><tr>
                               <td>Poster</td><td>:</td> <td><input type="file" value="Choose file" id="gambar" name="gambar"></td></tr>
                            </div>
                            </table>
